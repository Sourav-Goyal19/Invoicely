...
import { useCreateSalesTransaction } from "../api/use-create-sales-transaction";
...
const apiFormFields = insertSalesTransactionsSchema.omit({
  id: true,
  userId: true,
});
...
const NewSalesTransactionSheet = () => {
  ...
  const transactionMutation = useCreateSalesTransaction(data?.user?.email!);
...
export default NewSalesTransactionSheet;
